var kõrgemkunstikoolPallas = School(
    ...
    location: Location(
        city: .tartu,
        aadress: "Tähe 38b",
        latitude: 58.36940476832641,
        longitude: 26.729636391404263,
        mapLink: .pallas,
        branches: [
            Branch(city: .tartu, address: "Tähe 38b", latitude: 58.36940476832641, longitude: 26.729636391404263, mapLink: .pallas)
        ]
    ),
    ...
    image: .pallas,
    imageUrls: [
        "https://upload.wikimedia.org/wikipedia/commons/7/7d/K%C3%B5rgem_Kunstikool_Pallas_001-vaade-ylalt_pano_crop.jpg",
        "https://tankla.net/images/stories/uudistepildid/Kunstikool.jpg"
    ],
