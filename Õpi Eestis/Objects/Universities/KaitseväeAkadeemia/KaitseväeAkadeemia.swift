var Kaitseakadeemia = School(
    ...
    location: Location(city: .tartu, aadress: "Riia 12", coordinates: .kaitseväeAkadeemia),
    ...
    logo: .kaitseväeAkadeemia,
    image: .kaitseväeAkadeemia,
    internationalStudents: 0,
    worldRanking: 0,
    vastuvõtt: ["01.02. – 01.03.2021", "24.05. – 27.06.2021"]
)

let kaitseväeAkadeemiaEducation: [majorsMinors] = kaitseväeRaka + kaitseväeMaka
