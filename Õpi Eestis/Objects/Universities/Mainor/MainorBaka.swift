let mainorBaka = [
    majorsMinors(
        ...
        eap: 180,
        cost: Cost(amount: 3700, currency: .euro, interval: .year),
        modules: [
            Module(name: "Ettevõtlus", courses: [Course(name: "Ettevõtlusmoodul", eapCount: 15)]),
            Module(
                name: "Alusõpe",
                courses: [
            ...
            Module(
                name: "Veebidisain ja digitaalgraafika",
                courses: [
            ...
            Module(
                name: "Graafilise disaini moodul",
                courses: [
            ...
            Module(
                name: "Praktikad ja kirjalikud tööd",
                courses: [
    ...
    majorsMinors(
        ...
        studyLocation:  [.tallinn],
        eap: 180,
        cost: Cost(amount: 4720, currency: .euro, interval: .year),
        modules: [
            Module(
                name: "Start-up ettevõtlus",
                courses: [
    ...
    majorsMinors(
        ...
        eap: 180,
        cost: Cost(amount: 3640, currency: .euro, interval: .year),
        modules: [
            Module(
                name: "Ettevõtlusõpe",
                courses: [
            ...
            Module(
                name: "Ettevõtte juhtimise põhiõpe",
                courses: [
            ...
            Module(
                name: "Finantsjuhtimise erialaõpe",
                courses: [
    ...
    majorsMinors(
        ...
        modules: [
            ...
            Module(
                name: "Praktika ja kirjalikud tööd",
                courses: [
                    Course(name: "Ettevõttepraktika", eapCount: 12),
                    Course(name: "Erialapraktika", eapCount: 15),
                    Course(name: "Ainetöö", eapCount: 5),
    ...
    majorsMinors(
        ...
        modules: [
            Module(
                name: "Arvutimängude disaini ja arenduse erialaõpe",
                courses: [
            ...
            Module(
                name: "Arvutimängude disaini ja arenduse põhiõpe",
                courses: [
    ...
    majorsMinors(
        ...
        studyLocation: [.tallinn, .tartu],
        eap: 180,
        cost: Cost(amount: 3760, currency: .euro, interval: .year),
        modules: [
            Module(
                name: "Ettevõtlusõpe",
                courses: [
    ...
    majorsMinors(
        ...
        cost: Cost(amount: 3760, currency: .euro, interval: .year),
        modules: [
            Module(name: "Ettevõtlusmoodul", courses: [Course(name: "Ettevõtlusmoodul", eapCount: 15)]),
            Module(
                name: "Alusõpe",
                courses: [
                    Course(name: "Organisatsioonikäitumine", eapCount: 4),
            ...
            Module(
                name: "Veebidisaini ja digitaalgraafika põhiõpe",
                courses: [
                    Course(name: "Kasutajaliidese ja -kogemuse disain (UI/UX)", eapCount: 5),
                    Course(name: "Fototöötlus", eapCount: 5),
                    Course(name: "Arvutigraafika ja animatsioon", eapCount: 5),
            ...
            Module(
                name: "Veebitehnoloogiate erialaõpe",
                courses: [
    ...
    majorsMinors(
        ...
        studyLocation:  [.tallinn],
        eap: 180,
        cost: Cost(amount: 4660, currency: .euro, interval: .year),
        modules: [
            Module(name: "Ettevõtlusmoodul", courses: [Course(name: "Ettevõtlusmoodul", eapCount: 15)]),
            Module(
                name: "IT projekteerimine",
                courses: [
            ...
            Module(
                name: "Matemaatika ja Uurimistöö metoodika",
                courses: [
            ...
            Module(
                name: "Tarkvaraarenduse erialaõpe",
                courses: [
    ...
    majorsMinors(
        ...
        modules: [
            Module(
                name: "Kvaliteedijuhtimise erialaõpe",
                courses: [
    ...
    majorsMinors(
        ...
        modules: [
            ...
            Module(
                name: "Personalijuhtimise erialaõpe",
                courses: [
    ...
    majorsMinors(
        ...
        modules: [
            ...
            Module(
                name: "Teenusedisaini ja turnuduse õpe",
                courses: [
            ...
            Module(
                name: "Turismi- ja restoraniettevõtluse erialaõpe",
                courses: [
    ...
    majorsMinors(
        ...
        modules: [
            ...
            Module(
                name: "Loovuse ja äriinnovatsiooni erialaõpe",
                courses: [
