let mainorMaka = [
    majorsMinors(
        ...
        eap: 120,
        cost: Cost(amount: 4240, currency: .euro, interval: .year),
        modules: [
            Module(
            ...
            Module(
                name: "Inimressursside juhtimise erialaõpe",
                courses: [
    ...
    majorsMinors(
        ...
        modules: [
            ...
            Module(
                name: "Finantslahenduste juhtimise erialaõpe",
                courses: [
    ...
    majorsMinors(
        ...
        studyLocation:  [.tallinn],
        eap: 120,
        cost: Cost(amount: 4960, currency: .euro, interval: .year),
        modules: [
            Module(
                name: "Juhtimine",
                courses: [
            ...
            Module(
                name: "Rahvusvahelise ärijuhtimise erialaõpe",
                courses: [
