var kunstiakadeemia = School(
    ...
    location: Location(
        city: .tallinn,
        aadress: "Põhja Puiestee 7",
        latitude: 59.442550,
        longitude: 24.741083,
        mapLink: .kunstiAkadeemia,
        branches: [
            Branch(city: .tallinn, address: "Põhja Puiestee 7", latitude: 59.442550, longitude: 24.741083, mapLink: .kunstiAkadeemia)
        ]
    ),
    ...
    imageUrls: [
        "https://static-img.aripaev.ee/?type=preview&uuid=82a79391-4164-570d-ad90-786a1a1527fd&width=2000&q=85",
        "https://www.artun.ee/app/uploads/2019/03/betoonehitis_EKA-1440x600.jpg"
    ],
