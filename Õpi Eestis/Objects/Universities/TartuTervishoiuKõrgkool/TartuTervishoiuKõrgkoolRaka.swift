let tartuTervishoiuKõrgkoolRaka = [
    majorsMinors(
        ...
        modules: [
            ...
            Module(
                name: "Kutsealane ja isiksuslik areng",
                courses: [
            ...
            Module(
                name: "Rahvatervis, tervisedendus ja esmastandi õendus",
                courses: [
    ...
    majorsMinors(
        ...
        modules: [
            Module(
                name: "Emahooldus II ja esmatasandi tervishoid",
                courses: [
    ...
    majorsMinors(
        ...
        studyLocation:  [.tartu],
        eap: 180,
        cost: Cost(amount: 55, currency: .euro, interval: .eap),
        modules: [
            Module(
                name: "Füsioteraapia alusained",
                courses: [
            ...
            Module(
                name: "Füsioteraapia erialaained",
                courses: [
    ...
    majorsMinors(
        ...
        modules: [
            ...
            Module(
                name: "Patoloogia ja haigusõpetus",
                courses: [
            ...
            Module(
                name: "Järelevalve menetluse õiguslik regulatsioon",
                courses: [
            ...
            Module(
                name: "Laste- ja hoolekandeasutused",
                courses: [
            ...
            Module(
                name: "Teenuste ja toodete terviseohutus",
                courses: [
            ...
            Module(
                name: "Kutsealane ja isiklik areng",
                courses: [
                    Course(name: "Eetika ja filosoofia tervishoius", eapCount: 2),
            ...
            Module(
                name: "Nakkushaigused ja epidemioloogia",
                courses: [
            ...
            Module(
                name: "Väliskeskkonna saastumine",
                courses: [
            ...
            Module(
                name: "Psühhosotsiaalsed ja füsioloogilised ohutegurid",
                courses: [
    ...
    majorsMinors(
        ...
        modules: [
            ...
            Module(
                name: "Radiodiagnostilised meetodid organsüsteemide patoloogia diagnoosimisel",
                courses: [
            ...
            Module(
                name: "Patsiendi hooldus ja ohutus radiograafias",
                courses: [
            ...
            Module(
                name: "Kiirgusbioloogia, -füüsika, -aparatuur, -kaitse",
                courses: [
    ...
    majorsMinors(
        ...
        modules: [
            ...
            Module(
                name: "Farmakoloogia, toksikoloogia",
                courses: [
            ...
            Module(
                name: "Laboritöö alused ja keemia",
                courses: [
            ...
            Module(
                name: "Rakubioloogia, molekulaardiagnostika alused ja geneetika",
                courses: [
