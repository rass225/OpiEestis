let tartuTervishoiuKõrgkoolMaka = [
    majorsMinors(
        ...
        modules: [
            Module(
                name: "Kutseala arendamine ja kvaliteedijuhtimine",
                courses: [
            ...
            Module(
                name: "Erialamoodul - intensiivõendus",
                courses: [
            ...
            Module(
                name: "Erialamoodul - kliiniline õendus",
                courses: [
            ...
            Module(
                name: "Erialamoodul - terviseõendus",
                courses: [
            ...
            Module(
                name: "Erialamoodul - vaimse tervise õendus",
                courses: [
                    Course(name: "Kliiniline farmakoloogia", eapCount: 6),
    ...
    majorsMinors(
        ...
        studyLocation:  [.tartu],
        eap: 120,
        cost: Cost(amount: 3300, currency: .euro, interval: .year),
        modules: [
            Module(
                name: "Alusainete moodul",
                courses: [
            ...
            Module(
                name: "Erialaainete moodul: kiiritusravi",
                courses: [
            ...
            Module(
                name: "Õppepraktika moodul: kiiritusravi",
                courses: [
