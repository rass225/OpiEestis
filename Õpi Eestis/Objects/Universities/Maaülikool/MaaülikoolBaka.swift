let maaülikoolBaka = [
    ...
    majorsMinors(
        ...
        modules: [
            ...
            Module(name: "Bakalaureusetöö", courses: [Course(name: "Bakalaureusetöö", eapCount: 10)])
        ]
    ),
    majorsMinors(
        name: "Metsandus",
        ...
        modules: [
            ...
            Module(name: "Vabaained", courses: [Course(name: " Üliõpilased valivad vabaaineid nii oma ülikoolist kui ka teistest kõrgkoolidest. Õppeainete sisule piiranguid ei seata.", eapCount: 8)]
            ),
            Module(name: "Bakalaureusetöö", courses: [Course(name: "Bakalaureusetöö", eapCount: 10)])
        ]
    ),
    ...
    majorsMinors(
        ...
        modules: [
            ...
            Module(name: "Vabaained", courses: [Course(name: " Üliõpilased valivad vabaaineid oma ülikoolist või ka teistest kõrgkoolidest", eapCount: 8)]
            ),
            Module(
                name: "Bakalaureusetöö",
                courses: [
