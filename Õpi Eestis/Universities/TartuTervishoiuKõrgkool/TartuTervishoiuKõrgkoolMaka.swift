let tartuTervishoiuKõrgkoolMaka = [
    majorsMinors(
        ...
        outcomes: ["Õppekava läbinu on võimeline:", "Otsustama tõenduspõhise teabe asjakohasuse üle ning integreerima tervise ja heaolu valdkonna teoreetilisi teadmisi multidistsiplinaarse tervishoiuteenuse osutamisel.", "Töötama iseseisvalt tervishoiuvaldkonna spetsialistina ja tegema tulemuslikku interdistsiplinaarset koostööd nii meeskonnaliikmena kui ka eestvedajana.", "Hindama kriitiliselt erialase töö kvaliteeti ja panustama kvaliteetse tervishoiuteenuse osutamisse ja innovatsiooni.", "Planeerima ja eest vedama erialavaldkonna arendusprotsesse tuginedes olukorra kriitilisele analüüsile, kutseala regulatsioonidele, riiklikele ja rahvusvahelistele arengusuundadele.", "Argumenteerima eesti ja inglise keeles erialaga seotud aktuaalsetel teemadel ning esitama asjakohaseid seisukohti multiprofessionaalses meeskonnas ja ühiskondlikes aruteludes.", "Eest vedama väärtuspõhise tervise ja heaolu valdkonna teenuste arendamist ning rakendamist.", "Vastutama enda järjepideva arendamise ja erialase pädevuse tagamise eest.", "Juhendama ja suunama kolleege õppimisvajaduste analüüsimisel, enesearendamisel ja muutustega kohanemisel."],
        language: .eesti,
