var tartuTervishoiuKõrgkool = School(
    ...
    location: Location(
        city: "Tartu",
        aadress: "Nooruse 5",
        coordinates: "https://maps.apple.com/?address=Nooruse%205,%2050411%20Tartu,%20Estonia&auid=1368067964328569308&ll=58.365378,26.691359&lsp=9902&q=Tartu%20Tervishoiu%20K%C3%B5rgkool&_ext=ChgKBAgEEHUKBAgFEAMKBAgGEBkKBAgKEAASJikZyXlLLy5NQDGmPQ7Twq46QDmXnp+nVS9NQEFgMfBCJbM6QFAE&t=m"),
    ...
    education: tartuTervishoiuKõrgkoolRaka + tartuTervishoiuKõrgkoolMaka + tartuTervishoiuKõrgkoolKutse
)
