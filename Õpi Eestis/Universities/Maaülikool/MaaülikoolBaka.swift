let maaülikoolBaka = [
    majorsMinors(
        ...
        outcomes: ["Õppekava läbinud üliõpilane:", "On maamajandust tundev bakalaureusekraadiga spetsialist, kes omab süsteemset ülevaadet majanduslike protsesside üldistest seaduspärasustest ja oskusi ärivaldkonnas tegutsemiseks", "Tunneb ökonoomika põhimõisteid, ja omab teadmisi ökonoomilise analüüsi teostamiseks ja ettevõtte majandustegevuse tulemuste hindamiseks rõhuga maamajandusele, sh põllumajandusele", "Tunneb arvestuse aluseid ja rahanduse alusteooriaid, korraldab arvestust ja finantsjuhtimist ettevõtetes", "Oskab erialastele teadmistele tuginedes asutada ja majandada ettevõtet", "Oskab erialaste ülesannete ja probleemide lahendamiseks valida sobivaid meetodeid ning on valmis osalema vastavasisulistes aruteludes", "Tunneb maamajanduse arengusuundi ja aktuaalseid probleeme maaelus ja on orienteeritud panustama maamajanduse arendamisse", "Omab valmisolekut õpingute jätkamiseks ning iseseisvaks erialaseks ja tööalaseks täiendamiseks", "Osaleb aktiivselt kodanikuühiskonnas ning väärtustab oma eriala eetilisi aspekte ja ühiskondlikku rolli."],
        language: .eesti,
    ...
    majorsMinors(
        name: "Keskkonnaplaneerimine ja Maastikukujundus",
        level: .bachelor,
        type: .põllumajandus,
        requirements: [
            Requirements(term: "Eesti keele riigieksam"),
    ...
    majorsMinors(
        name: "Põllumajandussaaduste Tootmine ja Turundus",
        level: .bachelor,
        type: .põllumajandus,
        requirements: [
            Requirements(term: "Eesti keele riigieksam"),
