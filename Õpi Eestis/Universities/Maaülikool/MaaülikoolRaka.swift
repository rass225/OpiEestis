let maaülikoolRaka = [
    ...
    majorsMinors(
        ...
        modules: [
            ...
            Module(
                module: "Spetsialiseerumine: Mehaanika",
                courses: [
            ...
            Module(
                module: "Spetsialiseerumine: Elektroonika",
                courses: [
            ...
            Module(
                module: "Mehaanika eriala praktika",
                courses: [
                    Course(name: "Materjalide tehnoloogia praktika", eapCount: 3),
            ...
            Module(
                module: "Elektroonika eriala praktika",
                courses: [
            ...
            Module(module: "Vabaained", courses: [Course(name: "Üliõpilane valib vabaaineid nii oma ülikoolist kui ka teistest (välis)kõrgkoolidest", eapCount: 9)]
            ),
            Module(
                module: "Lõputöö",
                courses: [
