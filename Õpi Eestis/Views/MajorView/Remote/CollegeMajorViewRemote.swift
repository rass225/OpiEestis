...
struct CollegeMajorViewRemote: View {
...
private extension CollegeMajorViewRemote {
    var overviewView: some View {
        List {
            Section(content: statsContent, header: statsHeader)
                .listRowSeparator(.hidden)
            Section(content: youtubeView)
            Section(content: vimeoView)
            Section(content: spotifyView)
            Section(content: facebookView)
